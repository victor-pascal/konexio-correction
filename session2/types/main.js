...
console.log("Est-ce que j'aime le foot ? " + likeFootball + ", est de type " + typeof(likeFootball));
console.log("Autre chose, " + otherStuff + ", est de type " + typeof(otherStuff));
...
// Le resultat est 105 au lieu de 15
// Lorsque nous faisons l'addition de deux chaines de caractères, nous obtenons une concataination de ces deux chaines
